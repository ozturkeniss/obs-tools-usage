...
show_status() {
    ...
    echo "  🌐 FiberV2 Gateway: http://localhost:8083"
    echo "  📊 Gateway Admin: http://localhost:8083/admin"
    echo "  ❤️  Gateway Health: http://localhost:8083/health"
    echo "  📈 Gateway Metrics: http://localhost:8083/metrics"
    echo ""
    echo "  🛍️  Product HTTP API: http://localhost:8080"
    echo "  🛒 Basket HTTP API: http://localhost:8081"
    echo "  💳 Payment HTTP API: http://localhost:8082"
    echo ""
    echo "  🛍️  Product gRPC API: localhost:50050"
    echo "  🛒 Basket gRPC API: localhost:50051"
    echo "  💳 Payment gRPC API: localhost:50052"
    echo ""
    echo "  ❤️  Health Checks:"
    echo "    Product Health: http://localhost:8080/health"
    echo "    Basket Health: http://localhost:8081/health"
    echo "    Payment Health: http://localhost:8082/health"
    echo "    Gateway Health: http://localhost:8083/health"
    echo ""
    echo "  📈 Metrics:"
    echo "    Product Metrics: http://localhost:8080/metrics"
    echo "    Basket Metrics: http://localhost:8081/metrics"
    echo "    Payment Metrics: http://localhost:8082/metrics"
    echo "    Gateway Metrics: http://localhost:8083/metrics"
}
